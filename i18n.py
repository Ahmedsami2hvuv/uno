...
TEXTS = {
    ...
    "btn_withdraw": {"ar": "🚪 انسحاب", "en": "🚪 Withdraw"},
    "btn_cleanup": {"ar": "🧹 تنظيف الرسائل", "en": "🧹 Clean Messages"},
    "btn_uno": {"ar": "🔔 UNO!", "en": "🔔 UNO!"},
    "btn_catch": {"ar": "🚨 إمسك!", "en": "🚨 Catch!"},
    "no_suitable_card": {"ar": "❌ ماعندك ورقة مناسبة! راح اسحبلك ورقة خلال 5 ثواني...", "en": "❌ No suitable card! Will draw one for you in 5 seconds..."},
    "drew_playable_card": {"ar": "✅ سحبتلك ({card}) ومناسبة للعب! العبها 👍", "en": "✅ Drew ({card}) and it's playable! Play it 👍"},
    "drew_non_playable": {"ar": "❌ الورقة الي سحبتها ({card}) غير مناسبة للعب. راح يعبر دورك خلال 12 ثانية او دوس على زر مرر ⏭", "en": "❌ Drew card ({card}) is not playable. Will pass your turn in 12 seconds or press Skip ⏭"},
    "turn_skipped": {"ar": "⏭ تم تمرير دورك", "en": "⏭ Turn skipped"},
    "rules_full": {
